...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sp_sms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `book_authors`(`AuthorId`,`AuthorName`,`Description`) values (1,'Jahid',NULL),(2,'Mahabub Zaman',NULL),(3,'Manjur Mahmud',NULL),(4,'Hasan Imam',NULL),(5,'Silmat Shistry',NULL),(6,'Diruba Islam',NULL);
...
insert  into `organizations`(`OrganizationId`,`OrganizationName`,`OrganizationAddress_1`,`OrganizationAddress_2`,`OrganizationAddress_3`,`OrganizationLogo`,`CashMemoPrefix`,`MemoPrfix`,`StudentCodePrefix`) values (1,'Narayangonj Govt Girls High School','Masdair, Narayangonj',NULL,NULL,NULL,'SM-','PM-','NGGS-');
...
insert  into `parents`(`ParentId`,`StudentId`,`ParentName`,`ContactNumber`,`UserId`) values (1,135,'Golam Rosul','01552875498',6),(2,136,'Father ','01822447078',8),(3,137,'Rahmat ALi','01557369526',9);
...
insert  into `student_dormitories`(`StudentDormitoryId`,`StudentId`,`DormitoryId`,`RoomNumber`) values (1,137,1,'103');
...
insert  into `user_role_wise_privileges`(`id`,`controller`,`action`,`role_id`,`resource_id`) values (4484,'config_classes','index',10,NULL),(4485,'config_classes','view',10,NULL),(4486,'config_sections','index',10,NULL),(4487,'config_sections','view',10,NULL),(4488,'config_subjects','index',10,NULL),(4489,'config_subjects','view',10,NULL),(4490,'config_class_routines','index',10,NULL),(4491,'config_class_routines','view',10,NULL),(4492,'students','index',10,NULL),(4493,'students','view',10,NULL),(4494,'student_attendances','index',10,NULL),(4495,'student_attendances','view',10,NULL),(4496,'student_attendances','add',10,NULL),(4497,'student_attendances','edit',10,NULL),(4498,'student_attendances','delete',10,NULL),(4499,'fees','index',10,NULL),(4500,'fees','view',10,NULL),(4501,'fees','add',10,NULL),(4502,'fees','edit',10,NULL),(4503,'fees','delete',10,NULL),(4504,'manage_marks','index',10,NULL),(4505,'manage_marks','view',10,NULL),(4506,'manage_marks','add',10,NULL),(4507,'manage_marks','edit',10,NULL),(4508,'manage_marks','delete',10,NULL),(4509,'report_tabulation_sheets','index',10,NULL),(4510,'report_tabulation_sheets','view',10,NULL),(4511,'report_tabulation_sheets','add',10,NULL),(4512,'report_tabulation_sheets','edit',10,NULL),(4513,'report_tabulation_sheets','delete',10,NULL),(4514,'report_mark_sheets','index',10,NULL),(4515,'report_mark_sheets','view',10,NULL),(4516,'report_mark_sheets','add',10,NULL),(4517,'report_mark_sheets','edit',10,NULL),(4518,'report_mark_sheets','delete',10,NULL),(4774,'report_mark_sheets','index',13,NULL),(4775,'report_mark_sheets','view',13,NULL),(4776,'report_mark_sheets','add',13,NULL),(4777,'report_mark_sheets','edit',13,NULL),(4778,'report_mark_sheets','delete',13,NULL),(4779,'users','change_password',13,NULL),(4780,'report_attendance_registers','index',13,NULL),(4781,'report_attendance_registers','view',13,NULL),(4782,'report_attendance_registers','add',13,NULL),(4783,'report_attendance_registers','edit',13,NULL),(4784,'report_attendance_registers','delete',13,NULL),(4785,'organizations','index',1,NULL),(4786,'organizations','view',1,NULL),(4787,'organizations','add',1,NULL),(4788,'organizations','edit',1,NULL),(4789,'organizations','delete',1,NULL),(4790,'config_classes','index',1,NULL),(4791,'config_classes','view',1,NULL),(4792,'config_classes','add',1,NULL),(4793,'config_classes','edit',1,NULL),(4794,'config_classes','delete',1,NULL),(4795,'config_sections','index',1,NULL),(4796,'config_sections','view',1,NULL),(4797,'config_sections','add',1,NULL),(4798,'config_sections','edit',1,NULL),(4799,'config_sections','delete',1,NULL),(4800,'config_subjects','index',1,NULL),(4801,'config_subjects','view',1,NULL),(4802,'config_subjects','add',1,NULL),(4803,'config_subjects','edit',1,NULL),(4804,'config_subjects','delete',1,NULL),(4805,'config_class_periods','index',1,NULL),(4806,'config_class_periods','view',1,NULL),(4807,'config_class_periods','add',1,NULL),(4808,'config_class_periods','edit',1,NULL),(4809,'config_class_periods','delete',1,NULL),(4810,'config_class_routines','index',1,NULL),(4811,'config_class_routines','view',1,NULL),(4812,'config_class_routines','add',1,NULL),(4813,'config_class_routines','edit',1,NULL),(4814,'config_class_routines','delete',1,NULL),(4815,'students','index',1,NULL),(4816,'students','view',1,NULL),(4817,'students','add',1,NULL),(4818,'students','edit',1,NULL),(4819,'students','delete',1,NULL),(4820,'batch_students','index',1,NULL),(4821,'batch_students','view',1,NULL),(4822,'batch_students','add',1,NULL),(4823,'batch_students','edit',1,NULL),(4824,'batch_students','delete',1,NULL),(4825,'student_attendances','index',1,NULL),(4826,'student_attendances','view',1,NULL),(4827,'student_attendances','add',1,NULL),(4828,'student_attendances','edit',1,NULL),(4829,'student_attendances','delete',1,NULL),(4830,'fee_configurations','index',1,NULL),(4831,'fee_configurations','view',1,NULL),(4832,'fee_configurations','add',1,NULL),(4833,'fee_configurations','edit',1,NULL),(4834,'fee_configurations','delete',1,NULL),(4835,'fees','index',1,NULL),(4836,'fees','view',1,NULL),(4837,'fees','add',1,NULL),(4838,'fees','edit',1,NULL),(4839,'fees','delete',1,NULL),(4840,'exams','index',1,NULL),(4841,'exams','view',1,NULL),(4842,'exams','add',1,NULL),(4843,'exams','edit',1,NULL),(4844,'exams','delete',1,NULL),(4845,'grade_points','index',1,NULL),(4846,'grade_points','view',1,NULL),(4847,'grade_points','add',1,NULL),(4848,'grade_points','edit',1,NULL),(4849,'grade_points','delete',1,NULL),(4850,'manage_marks','index',1,NULL),(4851,'manage_marks','view',1,NULL),(4852,'manage_marks','add',1,NULL),(4853,'manage_marks','edit',1,NULL),(4854,'manage_marks','delete',1,NULL),(4855,'report_tabulation_sheets','index',1,NULL),(4856,'report_tabulation_sheets','view',1,NULL),(4857,'report_tabulation_sheets','add',1,NULL),(4858,'report_tabulation_sheets','edit',1,NULL),(4859,'report_tabulation_sheets','delete',1,NULL),(4860,'report_mark_sheets','index',1,NULL),(4861,'report_mark_sheets','view',1,NULL),(4862,'report_mark_sheets','add',1,NULL),(4863,'report_mark_sheets','edit',1,NULL),(4864,'report_mark_sheets','delete',1,NULL),(4865,'employees','index',1,NULL),(4866,'employees','view',1,NULL),(4867,'employees','add',1,NULL),(4868,'employees','edit',1,NULL),(4869,'employees','delete',1,NULL),(4870,'employee_designations','index',1,NULL),(4871,'employee_designations','view',1,NULL),(4872,'employee_designations','add',1,NULL),(4873,'employee_designations','edit',1,NULL),(4874,'employee_designations','delete',1,NULL),(4875,'ac_ledgers','index',1,NULL),(4876,'ac_ledgers','view',1,NULL),(4877,'ac_ledgers','add',1,NULL),(4878,'ac_ledgers','edit',1,NULL),(4879,'ac_ledgers','delete',1,NULL),(4880,'ac_payment_vouchers','index',1,NULL),(4881,'ac_payment_vouchers','view',1,NULL),(4882,'ac_payment_vouchers','add',1,NULL),(4883,'ac_payment_vouchers','edit',1,NULL),(4884,'ac_payment_vouchers','delete',1,NULL),(4885,'ac_receipt_vouchers','index',1,NULL),(4886,'ac_receipt_vouchers','view',1,NULL),(4887,'ac_receipt_vouchers','add',1,NULL),(4888,'ac_receipt_vouchers','edit',1,NULL),(4889,'ac_receipt_vouchers','delete',1,NULL),(4890,'ac_income_statements','index',1,NULL),(4891,'ac_income_statements','view',1,NULL),(4892,'student_dormitories','index',1,NULL),(4893,'student_dormitories','view',1,NULL),(4894,'student_dormitories','add',1,NULL),(4895,'student_dormitories','edit',1,NULL),(4896,'student_dormitories','delete',1,NULL),(4897,'users','index',1,NULL),(4898,'users','view',1,NULL),(4899,'users','add',1,NULL),(4900,'users','edit',1,NULL),(4901,'users','delete',1,NULL),(4902,'users','change_password',1,NULL),(4903,'user_roles','index',1,NULL),(4904,'user_roles','view',1,NULL),(4905,'user_roles','add',1,NULL),(4906,'user_roles','edit',1,NULL),(4907,'user_roles','delete',1,NULL),(4908,'user_roles','user_role_wise_privillige',1,NULL),(4909,'report_attendance_registers','index',1,NULL),(4910,'report_attendance_registers','view',1,NULL),(4911,'report_attendance_registers','add',1,NULL),(4912,'report_attendance_registers','edit',1,NULL),(4913,'report_attendance_registers','delete',1,NULL);
