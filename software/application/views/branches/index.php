...
<div class="col-md-12">
    <div class="panel panel-visible" id="spy2">
        <div class="panel-heading" style="padding: 0px;">
            <div class="panel-title hidden-xs" style="width: 87%; float: left">
            ...
            <table class="table table-striped table-hover" >
                ...
                foreach($results as $row){
                    ...
                    <tr>
                        ...
                        <td><?php echo $yes_no_option[$row->IsHeadOffice]; ?></td>
                        <td class="button-column">
                            <?php
                            if($session_data['role_id'] ==1){
                                echo anchor('branches/edit/' . $row->BranchId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                                //echo anchor('branches/delete/' . $row->BranchId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                            }else if($row->IsHeadOffice != 1){
                                echo anchor('branches/edit/' . $row->BranchId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                            }
                            ?>
                        </td>
