        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($results as $list){ ?>
                <tr>
                    ...
                    <td><?php echo $list->ClassCode; ?></td>
                   
                    <td><?php echo $list->BranchName; ?></td>
                    <td>
                        <?php
                        echo anchor('config_classes/edit/' . $list->ClassId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                        echo anchor('config_classes/delete/' . $list->ClassId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                        ?>
                    </td>
                </tr>
                <?php
