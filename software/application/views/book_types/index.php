            ...
            <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                ...
                foreach($list as $r){?>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo anchor('book_types/edit/' . $r->TypeId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                            echo anchor('book_types/delete/' . $r->TypeId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                            ?>
                        </td>
                    </tr>
                    <?php
