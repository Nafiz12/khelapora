        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo site_url('report_student_dues/view'); ?>" role="form"
...
<script type="text/javascript" language="javascript">
    $("#student_info").autocomplete('<?php echo site_url("students/ajax_get_student_list/")?>', {
        ...
        formatItem: function (row, i, max, term) {
            ...
            var tmp;
            tmp = row[0].split(",");
            return "<strong>" + tmp[1] + "</strong>" + "<br><strong>Class :" + tmp[4] + "</strong>" + "<br>Section : " + tmp[6] + "<br />Father's Name : " + tmp[2] + "<br />Contact Number : " + tmp[7] + "</span>";
        },
        ...
        student_table_data += '<tr><td colspan="2">Class : <b>' + tmp[4] + '</b></td></tr>'
        student_table_data += '<tr><td colspan="2">Section : <b>' + tmp[5] + '</b></td></tr>'
        student_table_data += '<tr><td colspan="2">Code : <b>' + tmp[8] + '</b></td></tr>'
        student_table_data += '<tr><td colspan="2">Roll : <b>' + tmp[9] + '</b></td></tr>';
