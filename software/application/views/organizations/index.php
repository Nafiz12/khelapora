...
<script>
    $(document).ready( function () {
        $("#edit_new_function").click(function(){
            window.location.href="<?php echo base_url();?>index.php/organizations/edit/1";
        });
    });
</script>
<div class="col-md-12">
    <div class="panel panel-visible" id="spy2">
        <div class="panel-heading" style="padding: 0px;">
            ...
            <div style="float: right;">
                <button class="btn active btn-alert btn-block" id="edit_new_function" type="button">Edit &nbsp; <span class="glyphicons glyphicons-circle_plus"></span></button>
            </div>
        </div>
        <div class="table-responsive">
            <table class="table table-striped table-hover"  cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th><b>Address</b></th>
                    <th><b>Income Memo Prefix</b></th>
                    <th><b>Expense Memo Prefix</b></th>
                    <th><b>Student Code Prefix</b></th>
                </tr>
                </thead>
                <tbody>
                <?php
                ...
                foreach($results as $row){
                    ...
                    <tr>
                        ...
                        <td><?php echo $row->OrganizationAddress_1; ?></td>
                        <td><?php echo $row->CashMemoPrefix; ?></td>
                        <td><?php echo $row->MemoPrfix; ?></td>
                        <td><?php echo $row->StudentCodePrefix; ?></td>
                    </tr>
                    <?php
                    $i++;
                }
