        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo site_url('ac_vouchers/'.$action); ?>" role="form" method="POST" enctype="multipart/form-data" onsubmit="return validate_form();">
                        <?php
                        if ($action == "edit") {
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <?php echo form_dropdown('VoucherType', $voucher_type_list, set_value('VoucherType', (isset($Voucher_data->VoucherType) ? $Voucher_data->VoucherType : "")), 'id="VoucherType", class="custom_checkbox" '); ?>
                                <input type="hidden" name="LocationId" id="LocationId" value="<?php echo isset($Voucher_data->VoucherDate) ? $Voucher_data->VoucherDate : $LocationId; ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <?php echo form_dropdown('cbo_credit', $credit_amount_options, set_value('cbo_credit', (isset($Voucher_data->VoucherType) ? $Voucher_data->VoucherType : "")), 'id="cbo_credit", class="custom_checkbox" '); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <?php echo form_dropdown('cbo_debit', $debit_amount_options, set_value('cbo_debit', (isset($Voucher_data->VoucherType) ? $Voucher_data->VoucherType : "")), 'id="cbo_debit", class="custom_checkbox" '); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="VoucherAmount" id="VoucherAmount" class="form-control" required="required" value="<?php echo isset($Voucher_data->VoucherAmount)?$Voucher_data->VoucherAmount:0; ?>" placeholder="Amount">
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function() {
        ...
        $("#VoucherType").change(function(){
            ...
            if(VoucherType !=''){
                // Start Voucher Code
                $.post('<?php echo site_url("ac_vouchers/ajax_get_voucher_code/")?>', {VoucherType: VoucherType,LocationId: LocationId },
                    function(data){
                        if(data.status == 'failure' ){
