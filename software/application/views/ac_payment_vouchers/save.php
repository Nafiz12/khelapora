        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo site_url('ac_payment_vouchers/'.$action); ?>" role="form" method="POST" enctype="multipart/form-data" onsubmit="return validate_form();">
