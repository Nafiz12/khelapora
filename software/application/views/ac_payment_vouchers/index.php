...
<div class="panel" id="spy7">
    <div class="panel-heading1">
        <?php echo form_open('ac_payment_vouchers/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($list as $row){ ?>
                <tr>
                    ...
                    <td><?php echo $row->VoucherType = 'P'?'Payment':'Receipt'.' Voucher';  ?></td>
                    ...
                    <td>
                        ...
                        if($row->IsAutoVoucher == 0){
                            echo anchor('ac_payment_vouchers/edit/' . $row->VoucherId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')) . '&nbsp';
                            echo anchor('ac_payment_vouchers/delete/' . $row->VoucherId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete', 'onclick' => "return confirm('Are You Sure To Delete This Type Information')"));
                        }
                        ?>
                    </td>
                </tr>
