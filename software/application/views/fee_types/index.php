...
<div class="col-md-12">
    <div class="panel panel-visible" id="spy2">
        <div class="panel-heading" style="padding: 0px;">
            <div class="panel-title hidden-xs" style="float: left">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                ...
                <tr>
                    <th>SL</th>
                    <th>Type Name</th>
                    <th>Is Monthly Fee</th>
                    <th>Is One Time Fee</th>
                    <th>Is Waiver Applicable</th>
                    <th>Action</th>
                </tr>
                </thead>
                <tbody>
                ...
                foreach($results as $row){
                    ...
                    <tr>
                        ...
                        <td><?php echo $yes_no_option[$row->IsMonthlyFee]; ?></td>
                        <td><?php echo $yes_no_option[$row->IsOneTimeFee]; ?></td>
                        <td><?php echo $yes_no_option[$row->IsWaiverApplicable]; ?></td>
                        <td class="button-column">
                            ...
                            echo anchor('fee_types/edit/' . $row->TypeId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                            echo anchor('fee_types/delete/' . $row->TypeId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
