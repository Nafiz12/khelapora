        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo site_url('authors/'.$action); ?>" role="form" method="POST" enctype="multipart/form-data">
                        <?php
                        if ($action == "edit") {
                            ?>

                            <input type="hidden" name="AuthorId" value="<?php echo isset($row->AuthorId)?$row->AuthorId:""?>">
                            <?php
                        }
                        ?>

                        <div class="form-group">
                            <label for="inputStandard" class="col-lg-3 control-label">Author Name</label>
                            <div class="col-lg-5">
                                <input type="text" name="txt_name" id="txt_name" class="form-control" required="required" value="<?php echo isset($row->AuthorName)?$row->AuthorName:''; ?>" placeholder="Author Name">
