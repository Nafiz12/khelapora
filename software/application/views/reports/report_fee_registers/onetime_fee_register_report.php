            ...
            <div class="col-md-12">
                <table class="scale" cellspacing="0" width="100%" cellpadding="6" align="center">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($onetime_fee_list as $row){
                    ...
                    foreach ($student_list as $key=>$student) {
                        ?>
                        <tr>
                            <td><label><?php echo $student['StudentName']; ?></label></td>
                            <td><label><?php echo $student['StudentCode']; ?></label></td>
                            <td><label><?php echo $student['RollNo']; ?></label></td>
                            <td><label><?php echo $student['FathersName']; ?></label></td>
                            <td><label><?php echo $student['ContactNumber']; ?></label></td>
                            <?php
                            foreach($onetime_fee_list as $key1=>$row1){
                                $payable_amount = $row1['Amount'];
