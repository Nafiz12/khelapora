        ...
        <div>
            <div class="col-md-12" style="margin-bottom: 1%;" >
                <table class="" border="0" cellspacing="0" width="88%" cellpadding="6" align="center">
                    <thead>
                    <tr>
                        <?php $info = $exam_info->ExamName.' : Class '.$class_info->ClassName.' | '.$section_info->SectionName.' ( '.$FromDate. ' to '.$ToDate.' )';?>
                ...
                <table class="scale" cellspacing="0" width="100%" cellpadding="6" align="center">
                    ...
                    foreach ($student_list as $key=>$row) {
                        ...
                        <tr>
                            ...
                            <td><label><?php echo $row['RollNo']; ?></label></td>
                            <?php
                            foreach($subject_list as $key1=>$row1){
                                if(isset($tabulation_sheet_data[$key][$key1])){
                                    echo '<td style="text-align: center">'.$tabulation_sheet_data[$key][$key1]['TotalMark'];
                                }
                                else{
                                    echo'<td>'.'&nbsp'.'</td>';
                                }
