        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" target="_blank" action="<?php echo site_url('student_histories/ajax_for_get_student_list_by_class_and_section_payment'); ?>" role="form" method="POST" enctype="multipart/form-data">
