            ...
            <div class="col-md-12">
                <table class="scale" cellspacing="0" width="100%" cellpadding="6" align="center">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center" ><label>Contact </label></td>
                        <td style="text-align: center" ><label>Admission Date</label></td>
                        <td style="text-align: left" ><label>Fee Type</label></td>
                        <td style="text-align: left" ><label>Payable Amount</label></td>
                        <td style="text-align: left" ><label>Paid Amount</label></td>
                        <td style="text-align: left" ><label>Due/Adv.</label></td>
                        <td style="text-align: left" ><label>Due Date</label></td>
                    ...
                    foreach ($student_info as $key=>$row) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:center"><?php echo $row['TypeName']; ?></td>
                            <td style="text-align:center"><?php echo $row['ActualAmount']; ?></td>
                            <td style="text-align:center"><?php echo $row['PaidAmount']; ?></td>
                            <td style="text-align:center"><?php echo ($row['ActualAmount']- $row['PaidAmount']); ?></td>
                            
                            <td style="text-align:left"><?php echo $row['DueDate']; ?></td>
