        ...
        <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
            ...
            foreach($results as $row){
                ...
                <tr>
                    ...
                    <td><?php echo $shift_list[$row->Shift]; ?></td>
                    <td><?php echo $medium_list[$row->Medium]; ?></td>
                    <td><?php echo $row->Year; ?></td>
                    <td class="button-column">
                        <?php
                        echo anchor('exam_routines/view/' . $row->RoutineId, img(array('src' => base_url() . 'media/assets/img/icons/view1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'view', 'class' => 'view')).'&nbsp';
                        echo anchor('exam_routines/delete/' . $row->RoutineId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
