...
<div class="panel" id="spy7">
    <div class="panel-heading1">
        <?php echo form_open('config_subjects/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
    ...
    <div class="panel-body pn">
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($results as $list){ ?>
                <tr>
                    <td><?php echo $a; ?></td>
                    <td><?php echo $list->BranchName; ?></td>
                    <td><?php echo $list->SubjectName; ?></td>
                    <td>
                        <?php
                        echo anchor('config_subjects/edit/' . $list->SubjectId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                        echo anchor('config_subjects/delete/' . $list->SubjectId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                        ?>
                    </td>
                </tr>
                <?php
