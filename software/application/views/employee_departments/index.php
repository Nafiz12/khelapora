                ...
                foreach($list as $row){
                    ...
                    <tr>
                        ...
                        <td class="button-column">
                            ...
                            echo anchor('employee_departments/edit/' . $row->DepartmentId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                            echo anchor('employee_departments/delete/' . $row->DepartmentId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
