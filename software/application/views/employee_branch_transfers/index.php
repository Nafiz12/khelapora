        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($list as $row){ ?>
                <tr>
                    ...
                    <td><?php echo $row->OldBranch; ?></td>
                    <td><?php echo $row->NewBranch; ?></td>
                    <td>
                        <?php
                        echo anchor('employee_branch_transfers/delete/' . $row->TransferId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                        ?>
                    </td>
                </tr>
                <?php
