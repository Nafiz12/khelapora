...
<div class="panel" id="spy7">
    <div class="panel-heading1">
        <?php echo form_open('manage_marks/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
        ...
        <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
            ...
            foreach($results as $row){
                ...
                <tr>
                    ...
                    <td><?php echo 'Class '.$row->ClassName.' | '.' Section/Batch '.$row->SectionName; ?></td>
                    <td><?php echo $row->SubjectName; ?></td>
                    <td><?php echo $row->ExamDate; ?></td>
                    <td class="button-column">

                        <?php
                        echo anchor('manage_marks/view/' . $row->BranchId.'/'.$row->ExamId.'/'.$row->ExamDate.'/'.$row->ClassId.'/'.$row->SectionId.'/'.$row->SubjectId, img(array('src' => base_url() . 'media/assets/img/icons/view1.gif', 'border' => '0', 'alt' => 'view')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                        echo anchor('manage_marks/edit/' . $row->BranchId.'/'.$row->ExamId.'/'.$row->ExamDate.'/'.$row->ClassId.'/'.$row->SectionId.'/'.$row->SubjectId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'editt')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                        echo anchor('manage_marks/delete/' . $row->BranchId.'/'.$row->ExamId.'/'.$row->ExamDate.'/'.$row->ClassId.'/'.$row->SectionId.'/'.$row->SubjectId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'delete')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This ?')"));
