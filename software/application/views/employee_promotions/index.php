...
<div class="panel" id="spy7">
    <div class="panel-heading1">
        <?php echo form_open('employee_promotions/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($list as $row){ ?>
                <tr>
                    ...
                    <td><?php echo $row->OldDesignationName; ?></td>
                    <td><?php echo $row->NewDesignationName; ?></td>
                    <td>
                        <?php
                        echo anchor('employee_promotions/delete/' . $row->PromotionId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                        ?>
                    </td>
                </tr>
                <?php
