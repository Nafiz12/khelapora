...
foreach ($batch_list as $row1) {
    $batch_options[$row1->BatchName] = ($row1->BatchName);
}
...
<div class="panel" id="spy7">
    <div class="panel-heading1">
            <?php echo form_open('config_class_periods/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
            ...
            <div class="row" style="margin:0px;padding:0px">
                ...
                <div class="col-md-2">
                    <?php  echo form_dropdown('BatchName', $batch_options, set_value('BatchName', isset($session_data['BatchName'])?$session_data['BatchName']:""),'id="BatchName" class="form-control"'); ?>
                </div>
                ...
                foreach($results as $row){
                    ...
                    <tr>
                        ...
                        <td class="button-column">
                            ...
                            echo anchor('config_class_periods/edit/' . $row->BatchId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                            echo anchor('config_class_periods/delete/' . $row->BatchId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
