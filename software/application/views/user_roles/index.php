            ...
            <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                ...
                foreach($user_roles as $row){
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo anchor('user_roles/user_role_wise_privillige/' . $row['id'], img(array('src' => base_url() . 'media/silk/lock.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Permission', 'class' => 'view')).'&nbsp';
                            if($row['is_editable'] == 1){
                                echo anchor('user_roles/edit/' . $row['id'], img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')).'&nbsp';
                                echo anchor('user_roles/delete/' . $row['id'], img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete','onclick'=>"return confirm('Are You Sure To Delete This Type Information')"));
                            }
                            ?>
                        </td>
                    </tr>
