...
<div class="panel" id="spy7">
    <div class="panel-heading1">
        <?php echo form_open('ac_receipt_vouchers/index',array('id'=>'search_form','name'=>'search_form','method'=>"GET")); ?>
        <table class="filter" style="width: 100%">
            <tr>
                ...
                <td width="10%"><input type="text" id="PaymentDate1" class="form-control" placeholder="Date From" name="PaymentDate1" value="<?php echo isset($session_data['PaymentDate1'])?$session_data['PaymentDate1']:""; ?>"></td>
                <td width="10%"><input type="text" id="PaymentDate2" class="form-control" placeholder="Date To" name="PaymentDate2" value="<?php echo isset($session_data['PaymentDate2'])?$session_data['PaymentDate2']:""; ?>"></td>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($list as $row){ ?>
                <tr>
                    ...
                    <td><?php if($row->VoucherType == 'P'){echo 'Payment Voucher';}else{echo 'Receipt Voucher';}  ?></td>
                    ...
                    <td>
                        ...
                        if($row->IsAutoVoucher == 0) {
                            echo anchor('ac_receipt_vouchers/edit/' . $row->VoucherId, img(array('src' => base_url() . 'media/assets/img/icons/edit1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'edit', 'class' => 'edit')) . '&nbsp';
                            echo anchor('ac_receipt_vouchers/delete/' . $row->VoucherId, img(array('src' => base_url() . 'media/assets/img/icons/delete1.gif', 'border' => '0', 'alt' => 'Payment')), array('title' => 'Delete', 'class' => 'delete', 'onclick' => "return confirm('Are You Sure To Delete This Type Information')"));
                        }
                        ?>
                    </td>
                </tr>
