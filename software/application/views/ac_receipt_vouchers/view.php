        ...
        <div>
            <div class="col-md-12" style="margin-bottom: 1%;" >
                <table class="" border="0" cellspacing="0" width="100%" cellpadding="6" align="center">
                    ...
                    <tr>
                        <td width="10%" align="right" style="padding-right: 5px;"><b>Branch:</b></td>
                        <td width="70%"><?php echo $branch_info->BranchName;?></td>
        ...
        <div class="row" id="invoice-table">
            <div class="col-md-12">
                <table class="scale" cellspacing="0" width="100%" cellpadding="6" align="center">
                    ...
                    <tr>
                        <td width="5%">#</td>
                        <td align="center" width="20%">Ledger Name</td>
                        <td align="center" width="5%">Code</td>
                        <td align="right" width="10%">Debit Amount</td>
                        <td align="right" width="15%">Credit Amount</td>
                        <td width="40%">Line Note</td>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>Total</td>
                        <td align="right"><?php echo number_format($total_dr_amount,2,'.',','); ?></td>
                        <td align="right"><?php echo number_format($total_cr_amount,2,'.',','); ?></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="6"><b>In Words : <?php echo convertNumberToWord($total_dr_amount);?> Taka Only </b> </td>
                    </tr>
                    </tbody>
                </table>
