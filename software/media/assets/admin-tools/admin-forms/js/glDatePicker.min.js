        ...
        a.prototype = {
            show: function () {
                ...
                var g = this, d = g.el, b = g.options, c = g.calendar, j = "gldp-" + b.cssName, t = b.todayDate._val(),
                    u = t.time, h = b.borderSize + "px", y = function (b, m, a) {
                        ...
                        c.sort();
                        return c
                    }, H = y(0, 11, b.selectableMonths), v = y(t.year - 70, t.year + 1, b.selectableYears),
                    ...
                    f = d.outerWidth(), e, k = f / 7 + 6 * (b.borderSize / 7), f = f / 8 + 7 * (b.borderSize / 8);
                ...
                for (l = e = 0; 7 > e; e++)for (var q = 0; 7 > q; q++, l++) {
                    ...
                    if (e) {
                        ...
                        b.selectableDateRange && (s = !1, $.each(b.selectableDateRange, function (b, a) {
                            var c = a.from, d = a.to || null,
                                d = d || new Date(a.from.getFullYear(), a.from.getMonth(), a.from._max()), c = D(a,
                                c), d = D(a, d);
