        ...
        <div class="container">
            ...
            <div class="row" style = "text-align: justify;">
                <div class="col-md-8 info-blocks text-center"  style = "min-height:698px;">
                    ...
                    <div class="row">
                        <?php if(isset($year_list)){foreach ($year_list as $year){  ?>
                        <div class="col-md-4" style = "margin-top:10px;">
                        <a href = "<?php echo base_url();?>index.php/Welcomes/inside_photo_gallery/<?php echo $year['year'];?>">
                                <img class=" img-responsive guid" src="<?php echo base_url();?>lib/images/<?php echo $year['name'];?>" style = "padding: 4px;
line-height: 1.42857143;background-color: #fff;border: 1px solid #ddd;width:100%;display:inline-block;height:100px;" alt="No Preview" /></a><br>
                            <span><a href = "<?php echo base_url();?>index.php/Welcomes/inside_photo_gallery/<?php echo $year['year'] ;?>"> <?php echo $year['year'];?></a></span><br>
