            ...
            <div class="row" style = "text-align: justify;">
                <div class="col-md-8 info-blocks text-center"  style = "height:599px;">
                    ...
                    <!-- ==================== for showing details spech ==================================-->
                        ...
                        <?php if(isset($news_events_details)){foreach($news_events_details as $news_events){?>
                          <div class="panel-heading box-title white-bg" style="width: 104%;
            margin-left: -15px;background-color:#25708b;color:white; padding: 8px 10px 9px 15px;"><?php echo $news_events->headline;?></div>

                            <div class="row achievement-box" style = "text-align:justify;margin-top:0px; padding:20px;margin-bottom: 0px;">

                                <p style = "text-align: justify;font-weight: bold;" class=""><?php echo html_escape($news_events->title);?></p>
                                
                                 Published on : <?php echo date('Y-m-d',strtotime($news_events->created_on));?>
                                <br>
                <span class="pull-left event-image-box" s>
                    <img class=" img-responsive guid" src="<?php echo base_url();?><?php echo $news_events->image;?>" style = "padding: 4px;
line-height: 1.42857143;background-color: #fff;border: 1px solid #ddd;width:100%;display:inline-block;height:auto;" alt="" />
                    <!--                    <img src="media/imgAll/15-11-2017-1510737645.jpg" alt="Inaugural Program" class="img-responsive ">-->
                                ...
                                <p style = "text-align: justify;" class=""><?php echo htmlspecialchars_decode(stripslashes($news_events->details));?></p>
                                <br>
                                <!-- <div class="row">
                                    <div class="col-md-4">
