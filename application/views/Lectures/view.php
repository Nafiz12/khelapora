...
<div class="panel-heading box-title white-bg" style="width: 104%;
            margin-left: -15px;background-color:#DEEAE8; padding: 8px 10px 9px 15px;"><?php echo $achievement->headline;?></div>
                          <!--  <div class="row">
...
line-height: 1.42857143;background-color: #fff;border: 1px solid #ddd;width:50%;display:inline-block;height:auto;" alt="" />
